{{--
| Individual (Persona Física) · Primary Contact
| Ejecutivo email, then the contact person's details with email + phone
| confirmation. Standalone (no longer shares with the company flow).
--}}
<div class="mb-3">
...
<div class="row g-3">
    <div class="col-12 col-sm-6">
        <label for="contact_first_name" class="form-label">{{ __('Individual\'s Name') }}<span class="ob-req">*</span></label>
    ...
    <div class="col-12 col-sm-6">
        ...
        <input type="email" class="form-control" id="contact_email_confirmation"
            name="contact_email_confirmation" value="{{ old('contact_email_confirmation') }}" required>
    </div>
    <div class="col-12 col-sm-6">
    ...
    <div class="col-12 col-sm-6">
        ...
        <input type="tel" class="form-control input-mono" id="contact_phone_confirmation"
            name="contact_phone_confirmation" value="{{ old('contact_phone_confirmation') }}" required>
    </div>
</div>